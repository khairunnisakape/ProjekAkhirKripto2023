      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link px-md-4 active" aria-current="page" href="homepage.php">Beranda</a>
            </li>
            <li class="nav-item">
              <a class="nav-link px-md-4" href="resep_saya.php">Resep Saya</a>
            </li>
            <li class="nav-item">
              <a class="nav-link px-md-4" href="resep_lain.php">Resep Lainnya</a>
            </li>
            <li class="nav-item">
              <a class="nav-link px-md-4" href="bantuan.php">Bantuan</a>
            </li>
          </ul>
          <div class="d-flex">
            <a class="btn btn-get-started btn-get-started-blue text-white" href="logout.php">Log Out</a>
          </div>
        </div>
      </div>
    </nav>
        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <h1 class="title-text-big">
              ...
              <span style="color: #4E91F9">Kuliner Kriptografi</span>?<br class="d-lg-block d-none" />
              
            </h1>
            <p class="text-caption">
              Kuliner Kriptografi merupakan log-book untuk semua resep masakan yang ingin kamu jaga kerahasiaannya dengan memanfaatkan ilmu kriptografi.
              <br class="d-sm-block d-none" />
              Kami berupaya untuk terus menjamin integritas data dan kerahasiaan dari resep-resep yang telah dipercayakan tiap pelanggan kepada kami.
            </p>
